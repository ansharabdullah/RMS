...
class m_laporan extends CI_Model {
    ...
    public function editMS2($id, $sesuai_premium, $sesuai_solar, $sesuai_pertamax, $cepat_premium, $cepat_solar, $cepat_pertamax, $cepat_shift1_premium, $cepat_shift1_solar, $cepat_shift1_pertamax, $lambat_premium, $lambat_solar, $lambat_pertamax, $tidak_terkirim_premium, $tidak_terkirim_solar, $tidak_terkirim_pertamax,$total_lo_premium,$total_lo_solar,$total_lo_pertamax, $depot, $tahun, $bulan) {
        $query = $this->db->query("update ms2 set SESUAI_PREMIUM = $sesuai_premium,SESUAI_SOLAR=$sesuai_solar, SESUAI_PERTAMAX = $sesuai_pertamax,CEPAT_PREMIUM = $cepat_premium,CEPAT_SOLAR=$cepat_solar, CEPAT_PERTAMAX = $cepat_pertamax,CEPAT_SHIFT1_PREMIUM = $cepat_shift1_premium,CEPAT_SHIFT1_SOLAR=$cepat_shift1_solar, CEPAT_SHIFT1_PERTAMAX = $cepat_shift1_pertamax,LAMBAT_PREMIUM = $lambat_premium,LAMBAT_SOLAR=$lambat_solar, LAMBAT_PERTAMAX = $lambat_pertamax,TIDAK_TERKIRIM_PREMIUM = $tidak_terkirim_premium,TIDAK_TERKIRIM_SOLAR=$tidak_terkirim_solar, TIDAK_TERKIRIM_PERTAMAX = $tidak_terkirim_pertamax, TOTAL_LO_PREMIUM = $total_lo_premium, TOTAL_LO_SOLAR = $total_lo_solar, TOTAL_LO_PERTAMAX = $total_lo_pertamax where ID_MS2='$id'");
    ...
    public function simpanMS2($ms2) {
        ...
        for ($no = 0; $no < $ms2['jumlah']; $no++) {
            $id_log_harian = $ms2['id_log_harian'][$no];
...
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=1)as 'KM1',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=2)as 'KM2',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=3)as 'KM3',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=4)as 'KM4',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=5)as 'KM5',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=6)as 'KM6',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=7)as 'KM7',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=8)as 'KM8',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=9)as 'KM9',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=10)as 'KM10',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=11)as 'KM11',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=12)as 'KM12',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=13)as 'KM13',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=14)as 'KM14',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=15)as 'KM15',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=16)as 'KM16',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=17)as 'KM17',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=18)as 'KM18',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=19)as 'KM19',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=20)as 'KM20',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=21)as 'KM21',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=22)as 'KM22',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=23)as 'KM23',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=24)as 'KM24',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=25)as 'KM25',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=26)as 'KM26',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=27)as 'KM27',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=28)as 'KM28',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=29)as 'KM29',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=30)as 'KM30',
(select SUM(k.TOTAL_KM) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=31)as 'KM31',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=1)as 'RIT1',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=2)as 'RIT2',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=3)as 'RIT3',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=4)as 'RIT4',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=5)as 'RIT5',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=6)as 'RIT6',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=7)as 'RIT7',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=8)as 'RIT8',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=9)as 'RIT9',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=10)as 'RIT10',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=11)as 'RIT11',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=12)as 'RIT12',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=13)as 'RIT13',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=14)as 'RIT14',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=15)as 'RIT15',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=16)as 'RIT16',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=17)as 'RIT17',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=18)as 'RIT18',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=19)as 'RIT19',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=20)as 'RIT20',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=21)as 'RIT21',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=22)as 'RIT22',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=23)as 'RIT23',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=24)as 'RIT24',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=25)as 'RIT25',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=26)as 'RIT26',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=27)as 'RIT27',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=28)as 'RIT28',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=29)as 'RIT29',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=30)as 'RIT30',
(select SUM(k.RITASE_AMT) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=31)as 'RIT31',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=1)as 'KL1',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=2)as 'KL2',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=3)as 'KL3',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=4)as 'KL4',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=5)as 'KL5',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=6)as 'KL6',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=7)as 'KL7',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=8)as 'KL8',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=9)as 'KL9',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=10)as 'KL10',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=11)as 'KL11',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=12)as 'KL12',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=13)as 'KL13',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=14)as 'KL14',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=15)as 'KL15',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=16)as 'KL16',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=17)as 'KL17',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=18)as 'KL18',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=19)as 'KL19',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=20)as 'KL20',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=21)as 'KL21',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=22)as 'KL22',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=23)as 'KL23',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=24)as 'KL24',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=25)as 'KL25',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=26)as 'KL26',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=27)as 'KL27',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=28)as 'KL28',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=29)as 'KL29',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=30)as 'KL30',
(select SUM(k.TOTAL_KL) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=31)as 'KL31',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=1)as 'SPBU1',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=2)as 'SPBU2',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=3)as 'SPBU3',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=4)as 'SPBU4',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=5)as 'SPBU5',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=6)as 'SPBU6',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=7)as 'SPBU7',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=8)as 'SPBU8',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=9)as 'SPBU9',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=10)as 'SPBU10',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=11)as 'SPBU11',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=12)as 'SPBU12',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=13)as 'SPBU13',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=14)as 'SPBU14',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=15)as 'SPBU15',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=16)as 'SPBU16',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=17)as 'SPBU17',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=18)as 'SPBU18',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=19)as 'SPBU19',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=20)as 'SPBU20',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=21)as 'SPBU21',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=22)as 'SPBU22',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=23)as 'SPBU23',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=24)as 'SPBU24',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=25)as 'SPBU25',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=26)as 'SPBU26',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=27)as 'SPBU27',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=28)as 'SPBU28',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=29)as 'SPBU29',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=30)as 'SPBU30',
(select SUM(k.SPBU) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=31)as 'SPBU31',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=1)as 'RUPIAH1',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=2)as 'RUPIAH2',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=3)as 'RUPIAH3',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=4)as 'RUPIAH4',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=5)as 'RUPIAH5',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=6)as 'RUPIAH6',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=7)as 'RUPIAH7',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=8)as 'RUPIAH8',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=9)as 'RUPIAH9',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=10)as 'RUPIAH10',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=11)as 'RUPIAH11',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=12)as 'RUPIAH12',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=13)as 'RUPIAH13',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=14)as 'RUPIAH14',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=15)as 'RUPIAH15',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=16)as 'RUPIAH16',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=17)as 'RUPIAH17',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=18)as 'RUPIAH18',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=19)as 'RUPIAH19',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=20)as 'RUPIAH20',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=21)as 'RUPIAH21',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=22)as 'RUPIAH22',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=23)as 'RUPIAH23',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=24)as 'RUPIAH24',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=25)as 'RUPIAH25',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=26)as 'RUPIAH26',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=27)as 'RUPIAH27',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=28)as 'RUPIAH28',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=29)as 'RUPIAH29',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=30)as 'RUPIAH30',
(select SUM(k.PENDAPATAN) from kinerja_amt k,log_harian l where k.ID_LOG_HARIAN=l.ID_LOG_HARIAN and k.ID_PEGAWAI=p.ID_PEGAWAI and YEAR(l.TANGGAL_LOG_HARIAN)='$tahun' and MONTH(l.TANGGAL_LOG_HARIAN)='$bulan' and DAY(l.TANGGAL_LOG_HARIAN)=31)as 'RUPIAH31'
...
(select count(distinct k.ID_PEGAWAI) from kinerja_amt k, pegawai p where k.ID_LOG_HARIAN = l.ID_LOG_HARIAN and p.ID_PEGAWAI = k.ID_PEGAWAI and upper(p.JABATAN) = 'SUPIR') as JUMLAH_HADIR_SUPIR,
(select count(distinct k.ID_PEGAWAI) from kinerja_amt k, pegawai p where k.ID_LOG_HARIAN = l.ID_LOG_HARIAN and p.ID_PEGAWAI = k.ID_PEGAWAI and upper(p.JABATAN) = 'KERNET') as JUMLAH_HADIR_KERNET,
