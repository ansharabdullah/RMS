...
class m_apar extends CI_Model {
    ...
    {
        $query = $this->db->query("select a.ID_APAR,m.NOPOL,DATEDIFF(a.STORE_PRESSURE,now()) as store_pressure,DATEDIFF(a.CATRIDGE,now()) as  catridge,DATEDIFF(a.CO2,now()) as co2,
