...
class m_rencana_mt extends CI_Model {
    ...
    function getRencana($depot,$tanggal) {
        $data = $this->db->query("SELECT L.ID_LOG_HARIAN, R.ID_RENCANA,R.R_PREMIUM,R.R_PERTAMAX,R.R_PERTAMAXPLUS,R.R_PERTAMINADEX,R.R_SOLAR,R.R_BIOSOLAR,R.R_OWN_USE,L.TANGGAL_LOG_HARIAN from rencana R, log_harian L where R.id_log_harian=L.id_log_harian and L.ID_DEPOT= $depot and L.TANGGAL_LOG_HARIAN='$tanggal'");
        return $data->result();
    }
