        ...
        if ($dt->ID_DEPOT == $d->ID_DEPOT) {
            if ($triwulan == 1) {
                ?>
                                    ...
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW1_BULAN1 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW1_BULAN2 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW1_BULAN3 ?>;
                <?php
            } else if ($triwulan == 2) {
                ?>
                                    ...
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW2_BULAN1 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW2_BULAN2 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW2_BULAN3 ?>;
                ...
                ?>
                                    ...
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW3_BULAN1 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW3_BULAN2 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW3_BULAN3 ?>;
                ...
                ?>
                                    ...
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW4_BULAN1 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW4_BULAN2 ?>;
                                    realisasi_revenue = realisasi_revenue + <?php echo $dt->REALISASI_TW4_BULAN3 ?>;
