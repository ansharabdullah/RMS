        ...
        <!-- page start-->
                <section class="panel">
                        <header class="panel-heading">
                            Grafik KPI Bulanan TBBM <?php echo $kpi_bulan[0]->nama_depot?>
                        </header>
                ...
                <section class="panel">
                        <header class="panel-heading">
                            Key Performance Indicator (KPI) TBBM <?php echo $kpi_bulan[0]->nama_depot?> (Tahun <?php echo $tahun?>)
                        </header>
                    <div class="panel-body">
                        <div class="space15">
                        </div>
