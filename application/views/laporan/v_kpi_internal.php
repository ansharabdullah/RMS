                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[0]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr> 
                                <tr>
                                    <td rowspan="4">2</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[1]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[2]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[3]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="4">3</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[4]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[5]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[6]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[7]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[8]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[9]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[10]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="6">6</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[11]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[12]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[13]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[14]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="10">7</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[15]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>- Gas & Aviation (SPBE)</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[16]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[17]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>- Gas & Aviation (SPBE)</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[18]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[19]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[20]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="4">8</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[21]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[22]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[23]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td rowspan="7">9</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[24]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[25]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[26]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[27]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[28]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[29]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[30]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[31]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[32]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[33]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[34]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[35]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[36]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[37]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[38]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[39]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[40]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a data-placement="top" data-toggle="modal" href="#ModalEditKPI" onclick="setDetailKPI('<?php echo $data_kpi[41]->ID_KPI_INTERNAL; ?>')" class="btn btn-warning btn-xs tooltips" data-original-title="Edit"><i class="icon-pencil"></i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
