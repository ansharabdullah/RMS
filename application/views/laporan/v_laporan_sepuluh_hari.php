            ...
            <div class="panel-body" >
                <form class="cmxform form-horizontal tasi-form" action="#" role="form" id="commentForm">
                    <div class="form-group" id="tanggal">
                        ...
                        <div class="col-lg-10">
                            <input type="date" name="tanggal1" required="required" id="tglLaporan"  class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group" id="tanggal">
                        <label for="inputEmail1" class="col-lg-2 col-sm-2 control-label">Tanggal Akhir</label>
                        <div class="col-lg-10">
                            <input type="date" name="tanggal2" required="required" id="tglLaporan"  class="form-control"/>
                        </div>
                    </div>
