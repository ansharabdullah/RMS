...
?>
        ...
        $(function() {
            mt = new Highcharts.Chart({ 
                ...
                subtitle: {
                    text: 'Tanggal <?php echo $bulan_mt ?> <?php echo date("F", mktime(0, 0, 0, $hari, 1, 2005))?> <?php echo $tahun ?>',
                    x: -20
                },
                xAxis: {
    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <section class="panel">
                    <header class="panel-heading">
                        Tabel Kinerja Mobil Tangki <?php echo $bulan_mt ?> <?php echo date("F", mktime(0, 0, 0, $hari, 1, 2005))?> <?php echo $tahun ?>
                    </header>
                    <div class="panel-body">
                        ...
                        <div class="adv-table editable-table " >
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                    ...
                                    <td><?php echo $i ?></td>
                                    <td><a href="<?php echo base_url() ?>mt/detail_mt/<?php echo $row->ID_MOBIL; ?>/<?php echo $this->session->userdata("id_depot")?>/<?php echo $hari?>/<?php echo $tahun?>" style ="text-decoration: underline"><?php echo $row->NOPOL; ?></a></td>
