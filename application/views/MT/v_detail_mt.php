                            ...
                            <tbody>
                                 ...
                                 for ($i = 1; $i <= $jumlah; $i++) {
                                   ...
                                   <td>
                                    ...
                                    </td><td><a class="btn btn-danger btn-xs tooltips" data-original-title="Hapus" data-placement="top" onclick="hapusKinerja('<?php echo $row->id_kinerja_mt?>','<?php echo date('d M Y',  strtotime($row->tanggal_log_harian))?>')" data-toggle="modal" href="#ModalHapusKinerja"><i class="icon-remove"></i></a>                 
                                   </td>
                                    </tr>
                                <?php
                                                } else {
