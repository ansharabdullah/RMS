        ...
        <ul class="sidebar-menu" id="nav-accordion">
            ...
            ?>
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li <?php if ($lv2 == 1 && $lv1 == $level) echo "class='active'" ?>><a  href="<?php echo base_url() ?>amt/data_amt"  >AMT</a></li>
                            <li <?php if ($lv2 == 2 && $lv1 == $level) echo "class='active'" ?>><a  href="<?php echo base_url() ?>amt/grafik">MT</a></li>
                            <li <?php if ($lv2 == 3 && $lv1 == $level) echo "class='active'" ?>><a  href="<?php echo base_url() ?>amt/presensi" >KPI</a></li>
                        </ul>
                    </li>
            <?php
